  ...
  const features = [
    {
      ...
      description: 'Monitor social media sentiment as it happens across multiple platforms'
    },
    {
      icon: TrendingUp,
      title: 'Trending Topics',
      description: "Discover what's trending and analyze sentiment patterns over time"
    },
    {
      icon: BarChart3,
    ...
    },
    {
      ...
      description: 'Get intelligent recommendations based on sentiment analysis'
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: 'Process thousands of posts in seconds with our optimized engine'
    }
  ];

  return (
    <section className="features-section py-5 mx-3 mx-lg-4 rounded-5">
        ...
        <Row className="g-4">
          {features.map((feature, index) => (
            <Col md={6} lg={4} key={index}>
              <Card className="h-100 border-0 shadow-sm rounded-3 feature-card">
