...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div className={`d-flex flex-column vh-100 bg-white border-end ${isOpen ? 'position-fixed start-0 top-0' : 'position-fixed start-0 top-0 d-none d-lg-flex'
        }`}
          ...
          <div className="d-flex align-items-center gap-2">
            <div className="d-flex align-items-center justify-content-center"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="58" height="52" viewBox="0 0 58 52" fill="none">
                <path d="M3.422 24.6106L25.2981 47.3267C26.0234 48.0798 27.0181 48.5139 28.0634 48.5336C29.1087 48.5533 30.1191 48.157 30.8722 47.4317L53.5883 25.5556" stroke="url(#paint0_linear_12_2212)" stroke-width="6.84402" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M38.6003 28.0698V12.3013" stroke="url(#paint1_linear_12_2212)" stroke-width="6.84402" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M28.7445 28.0698V4.41702" stroke="url(#paint2_linear_12_2212)" stroke-width="6.84402" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M18.8895 28.0698V22.1566" stroke="url(#paint3_linear_12_2212)" stroke-width="6.84402" stroke-linecap="round" stroke-linejoin="round" />
                <defs>
          ...
          {menuItems.map((item, index) => (
            <NavItem key={index}>
              <NavLink
                ...
                to={item.path}
                onClick={closeSidebar}
                className={`d-flex align-items-center gap-3 px-3 py-2 rounded text-decoration-none ${isActive(item.path)
        ...
        <div className="p-3 border-top">
          <div className="d-flex align-items-center gap-3 mb-3">
            <div className="d-flex align-items-center justify-content-center bg-secondary bg-opacity-25 rounded-circle"
              style={{ width: '40px', height: '40px' }}>
              <span className="fw-semibold">S</span>
            </div>
            <div className="flex-grow-1 text-truncate">
              <div className="fw-medium small">Your Name</div>
              <div className="text-muted" style={{ fontSize: '0.75rem' }}>You@gmail.com</div>
            </div>
          </div>
          <NavLink
